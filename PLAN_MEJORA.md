...
### 3.1 Dividir OrderDetailPage.tsx
...
```typescript
// src/pages/admin/OrderDetailPage.tsx - reducido a 100 líneas
import OrderDetailHeader from '@/components/admin/OrderDetail/Header';
import OrderDetailEdit from '@/components/admin/OrderDetail/EditForm';
import OrderDetailMedia from '@/components/admin/OrderDetail/Media';
import OrderDetailGastos from '@/components/admin/OrderDetail/Gastos';
...
export function OrderDetailPage() {
  ...
  return (
    <AdminLayout>
      <OrderDetailHeader order={order} onSave={handleSave} />
...
**Nuevos Archivos**:
- `components/admin/OrderDetail/Header.tsx`
- `components/admin/OrderDetail/EditForm.tsx`
- `components/admin/OrderDetail/Media.tsx`
- `components/admin/OrderDetail/Gastos.tsx`
...
### 4.1 Implementar Caché en useTrackOrder

```typescript
// src/hooks/useTrackOrder.ts - con caché
const CACHE_TTL = 5 * 60 * 1000; // 5 minutos

export function useTrackOrder({ codigo, token }: UseTrackOrderOptions) {
...
### 4.2 Optimizar MediaGallery (Lazy Loading)
...
```typescript
// src/components/OrderProgress.stories.tsx
...
export const Recibido = () => <OrderProgress estado="RECIBIDO" />;
export const Pintura = () => <OrderProgress estado="PINTURA" />;
export const Terminado = () => <OrderProgress estado="TERMINADO" />;
```
...
- Revisar ANALISIS_PROYECTO.md para contexto
