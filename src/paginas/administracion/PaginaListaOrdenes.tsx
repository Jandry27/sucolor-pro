...
export function PaginaListaOrdenes() {
    ...
    const filtered = activeOrders.filter(o => {
        ...
        return (
            clienteNombres.includes(search) ||
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
                    <div>
                        ...
                        <p className="text-sm text-[rgba(15,23,42,0.60)] mt-0.5">
                            {activeOrders.length}{' '}
                            {activeOrders.length === 1 ? 'orden en proceso' : 'órdenes en proceso'}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3">
                        ...
                        <Link
                            to="/administracion/orders/nueva"
                            className="btn-primary flex-shrink-0 w-full sm:w-auto justify-center text-sm"
                        >
                ...
                {loading ? (
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {filtered.map((order, i) => {
                            ...
                            const eStyle = ESTADOS[order.estado] ?? {
                                label: order.estado,
                                color: '#6B7280',
                            };
                                        ...
                                        <div className="glass-card-hover h-full flex flex-col !p-4 !rounded-xl !border-slate-200/50">
                                            ...
                                            <div className="flex items-start justify-between gap-2 mb-3">
                                                <div className="flex gap-3">
                                                    ...
                                                    <div className="min-w-0 flex-1 pl-1 pt-0.5">
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <span className="font-mono-code text-xs text-[#F72F42] font-bold">
                                                                {order.codigo}
                                                            </span>
                                                        </div>
                                                ...
                                                <div className="flex flex-col items-end gap-1.5 flex-shrink-0 z-10">
                                                    <button
                                                        onClick={e =>
                                                            handleDelete(e, order.id, order.codigo)
                                                        }
                        ...
                        {filtered.length === 0 && (
                            <div className="sm:col-span-2 lg:col-span-3 xl:col-span-4 glass-card flex flex-col items-center py-14 gap-3">
                                ...
                                <p className="text-sm text-[rgba(15,23,42,0.50)]">
