            ...
            <div className="max-w-xl mx-auto space-y-6">
                ...
                {step === 'confirmado' && (
                    <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} className="glass-card space-y-5" style={{ padding: '32px' }}>
                        ...
                        <div className="flex gap-3">
                            <button onClick={() => navigate('/administracion/orders')} className="btn-secondary flex-1">Ir a Órdenes</button>
                            {ordenId && (
                                <button onClick={() => navigate(`/administracion/orders/${ordenId}`)} className="btn-secondary flex-1">Ver Orden</button>
                            )}
