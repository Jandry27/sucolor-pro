...
export function PaginaReportes() {
    const { orders, loading } = useOrdenes('ENTREGADO'); // Solo queremos facturados/entregados
    ...
    const handleDownloadCSV = () => {
        ...
        link.setAttribute(
            'download',
            `Reporte_SuColor_${MONTHS[selectedMonth]}_${selectedYear}.csv`
        );
            ...
            <div className="space-y-6 animate-fade-in print:space-y-4">
                ...
                <div className="hidden print:block text-center mb-6">
                    ...
                    <h2 className="text-xl font-bold">
                        Reporte de Ganancias - {MONTHS[selectedMonth]} {selectedYear}
                    </h2>
                    ...
                    >
                        ...
                        <div>
                            <p className="text-xs font-bold text-[#16A34A] uppercase tracking-wider">
                                Ingresos Totales ({MONTHS[selectedMonth]})
                            </p>
