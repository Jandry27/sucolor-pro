...
import { ModalFactura } from '@/componentes/administracion/ModalFactura';
import { PanelGastos } from '@/componentes/administracion/PanelGastos';
import { PanelPagos } from '@/componentes/administracion/PanelPagos';
import { PanelSubidaFotos } from '@/componentes/administracion/PanelSubidaFotos';
import { EncabezadoDetalleOrden } from '@/componentes/administracion/DetalleOrden/EncabezadoDetalleOrden';
import { FormularioEdicionDetalleOrden } from '@/componentes/administracion/DetalleOrden/FormularioEdicionDetalleOrden';
    ...
    return (
        <DisenoAdministracion>
            <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
                ...
                >
                    {isEditingDetails ? (
                        ...
                        <EncabezadoDetalleOrden
                            ...
                            onOpenInvoice={() => setIsModalFacturaOpen(true)}
                ...
                >
                    <PanelSubidaFotos ordenId={order.id} ordCodigo={order.codigo} />
                </motion.div>
            </div>
