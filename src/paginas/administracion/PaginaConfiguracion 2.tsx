        ...
        try {
            ...
            if (p12File) {
                ...
                const { error: uploadError } = await supabase.storage
                    .from('firmas')
                    .upload(filePath, p12File);
                if (uploadError)
                    console.warn(
                        'Supabase storage upload failed, ignoring for local test:',
                        uploadError.message
                    );
    ...
    return (
        <DisenoAdministracion>
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                {message && (
                    <div
                        className={`p-4 rounded-xl text-sm flex items-center gap-2 ${message.type === 'success' ? 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-400' : 'bg-red-50 text-red-700 dark:bg-red-500/10 dark:text-red-400'}`}
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={e =>
                                    setSettings({ ...settings, razon_social: e.target.value })
                                }
                                className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={e =>
                                    setSettings({ ...settings, nombre_comercial: e.target.value })
                                }
                                className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={e =>
                                    setSettings({ ...settings, direccion_matriz: e.target.value })
                                }
                                className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setSettings({ ...settings, punto_emision: e.target.value })
                                    }
                                    className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                                    placeholder="Ej. 100"
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setSettings({
                                            ...settings,
                                            secuencial_factura: e.target.value,
                                        })
                                    }
                                    className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    onChange={e =>
                                        setSettings({ ...settings, rimpe: e.target.checked })
                                    }
                                    className="rounded text-brand-orange focus:ring-brand-orange"
                                />
                                <span className="text-sm text-slate-700 dark:text-slate-300">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        setSettings({
                                            ...settings,
                                            agente_retencion: e.target.value,
                                        })
                                    }
                                    className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                                    placeholder="Ej. 1"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-colors dark:text-white"
                                    placeholder={
                                        settings.p12_storage_path
                                            ? 'Déjalo en blanco si no cambiaste el archivo'
                    ...
                    <div className="pt-4 flex justify-end">
                        <button type="submit" disabled={saving} className="btn-primary">
                            {saving ? (
                                ...
                                <>
                                    <Save className="w-4 h-4 mr-2 text-white" /> Guardar
                                    Configuración
                                </>
                            )}
                        </button>
