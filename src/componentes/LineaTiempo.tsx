...
import type { LineaTiempoEvent } from '@/tipos';
import { formatDateTime } from '@/biblioteca/constantes';

interface LineaTiempoProps {
    events: LineaTiempoEvent[];
}

export function LineaTiempo({ events }: LineaTiempoProps) {
    return (
        <motion.div
            ...
            {events.length === 0 ? (
                ...
                <div className="flex flex-col items-center gap-3 py-12">
                    ...
                    <div className="text-center">
                        <p className="text-sm font-medium text-[rgba(15,23,42,0.55)]">
                ...
                <div className="relative">
                    ...
                    <div
                        ...
                        style={{
                            background:
                                'linear-gradient(to bottom, rgba(249, 115, 22,0.35), rgba(249, 115, 22,0.04))',
                        }}
                    />
                                ...
                                <div className="flex-shrink-0 z-10">
                                    ...
                                    >
                                        <Clock
                                            ...
                                            style={{
                                                color: i === 0 ? '#F97316' : 'rgba(15,23,42,0.35)',
                                            }}
                                        />
                                    </div>
                                </div>
