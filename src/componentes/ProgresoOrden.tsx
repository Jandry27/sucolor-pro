...
import { STATUS_CONFIG, PROGRESS_STEPS } from '@/biblioteca/constantes';

interface ProgresoOrdenProps {
    estado: OrderStatus;
}

export function ProgresoOrden({ estado }: ProgresoOrdenProps) {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative">
                                    {isCurrent && (
                                        <div
                                            className="absolute -inset-1.5 rounded-full animate-pulse-orange"
