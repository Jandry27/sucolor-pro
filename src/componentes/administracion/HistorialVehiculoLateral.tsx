...
export function HistorialVehiculoLateral({ vehiculo, onClose }: Props) {
                ...
                <>
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between p-5 border-b border-[rgba(15,23,42,0.07)]">
                            ...
                            <button
                                onClick={onClose}
                                className="w-8 h-8 rounded-lg hover:bg-[rgba(15,23,42,0.06)] flex items-center justify-center text-[rgba(15,23,42,0.40)] hover:text-[#0F172A] transition-all flex-shrink-0"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>
