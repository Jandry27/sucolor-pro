...
export function PanelGastos({ ordenId }: PanelGastosProps) {
    ...
    return (
        <div className="glass-card space-y-4" style={{ padding: '20px' }}>
            ...
            {error && (
                <div
                    className="flex items-start gap-2 p-3 rounded-xl text-xs text-[#EF4444]"
                    style={{
                ...
                >
                    ...
                    <button
                        ...
                        className="text-[rgba(239,68,68,0.60)] hover:text-[#EF4444]"
                    >
                        ✕
                    </button>
                </div>
            ...
            <form
                ...
                className="bg-[#F7F8FA] p-3.5 rounded-xl border border-[rgba(15,23,42,0.07)] space-y-3"
            >
                <h4 className="text-xs font-bold text-[rgba(11,18,32,0.50)] uppercase tracking-wider mb-2">
                    Agregar nuevo Gasto
                </h4>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div className="md:col-span-2">
                        <label className="text-[10px] uppercase font-bold text-[rgba(15,23,42,0.40)] tracking-wider mb-1 block">
                            Descripción (Repuesto/Servicio)
                        </label>
                        <input
                            value={descripcion}
                            ...
                            required
                            type="text"
                            placeholder="Ej. Filtro de aceite, Pintura roja..."
                            className="w-full text-sm px-3 py-2 rounded-lg border border-[rgba(15,23,42,0.15)] bg-white/50 focus:outline-none focus:border-[#F97316]"
                            disabled={saving}
                        />
                    </div>
                    <div>
                ...
                <div className="pt-1">
                    ...
                    {!facturaUrl ? (
                        ...
                        >
                            ...
                            <span className="text-xs text-[rgba(15,23,42,0.50)] group-hover:text-[#F97316] transition-colors">
                        ...
                        <div className="relative inline-block border border-[rgba(15,23,42,0.10)] rounded-lg p-1 bg-white">
                            ...
                            <button
                                type="button"
                                onClick={removeFile}
                                className="absolute -top-2 -right-2 bg-white rounded-full p-0.5 shadow-sm border border-[rgba(15,23,42,0.1)] hover:bg-gray-50 text-[rgba(11,18,32,0.5)] hover:text-red-500"
                            >
                ...
                <div className="flex justify-end pt-2">
                    <button
                        type="submit"
                        disabled={saving || !descripcion.trim() || !monto}
            ...
            {/* Listado de Gastos */}
            <div className="mt-5">
                <h4 className="text-xs font-bold text-[rgba(15,23,42,0.50)] uppercase tracking-wider mb-3">
                    Historial de Repuestos / Gastos
                </h4>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center py-6 gap-2 bg-[rgba(15,23,42,0.02)] rounded-xl border border-[rgba(15,23,42,0.05)] border-dashed">
                        ...
                        <p className="text-sm text-[rgba(15,23,42,0.40)]">
                            No hay gastos registrados para esta orden
                        </p>
                    </div>
                ) : (
                            ...
                            {gastos.map(gasto => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-semibold text-[#0F172A] truncate placeholder:">
                                            {gasto.descripcion}
                                        </p>
            ...
            {lightbox && (
                <div
                    className="fixed inset-0 z-[100] bg-black/85 flex items-center justify-center p-4 cursor-zoom-out backdrop-blur-sm"
                ...
                >
                    ...
                    <div
                        className="bg-white rounded-2xl overflow-hidden max-w-full max-h-[85vh] relative"
                        onClick={e => e.stopPropagation()}
                    >
                        <div className="p-3 border-b border-gray-100 flex justify-between items-center bg-gray-50/80">
                            <span className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                                <Receipt className="w-4 h-4 text-gray-400" /> Factura / Recibo
                                adjunto
                            </span>
                            <button
                                onClick={() => setLightbox(null)}
