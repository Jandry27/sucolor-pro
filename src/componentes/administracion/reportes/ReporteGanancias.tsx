...
export function ReporteGanancias() {
    ...
    const handleDownloadCSV = () => {
        exportarCSV(
            ['Fecha de Entrega', 'Código', 'Cliente', 'Vehículo (Placa)', 'Ingreso ($)'],
            ...
            `Reporte_Ganancias_${MESES[selectedMonth]}_${selectedYear}`
        );
    };
    ...
    return (
        <div className="space-y-6 animate-fade-in print:space-y-4">
            ...
            <EncabezadoImpresion
                ...
                subtitulo={`${MESES[selectedMonth]} ${selectedYear}`}
                infoExtra={[`${filteredOrders.length} trabajos · $${totalIngresos.toFixed(2)} total`]}
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                    ...
                    <div>
                        <p className="text-xs font-bold text-[#16A34A] uppercase tracking-wider">
                            Ingresos Totales ({MESES[selectedMonth]})
                        </p>
                        <p className="text-3xl font-black text-[#16A34A] leading-none mt-1">
                ...
                >
                    ...
                    <div>
                        <p className="text-xs font-bold text-[rgba(15,23,42,0.60)] uppercase tracking-wider">
                            Trabajos Entregados
                        </p>
                        <p className="text-3xl font-bold text-[#0F172A] leading-none mt-1">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm whitespace-nowrap">
                        <thead className="bg-[#F8FAFC] border-b border-slate-200/50 print:bg-transparent">
                            <tr>
                                <th className="px-5 py-3.5 font-semibold text-[rgba(15,23,42,0.60)]">
                                    Fecha Entrega
                                </th>
                        ...
                        <tbody>
                            {loading && filteredOrders.length === 0 ? (
                                <tr>
                                    <td
                                        colSpan={5}
                                        className="px-5 py-8 text-center text-[rgba(11,18,32,0.40)]"
                                    >
                                        Generando reporte...
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td
                                        ...
                                        className="px-5 py-8 text-center text-[rgba(11,18,32,0.40)]"
                                    >
                                        No se encontraron trabajos entregados en{' '}
                                ...
                                filteredOrders.map(order => (
                                    <tr
                                        key={order.id}
                                        className="border-b border-[rgba(15,23,42,0.04)] hover:bg-[rgba(247,47,66,0.02)] transition-colors print:border-b-gray-200 group"
                                    >
                                        ...
                                        <td className="px-5 py-3">
                                            <Link
                                                to={`/administracion/orders/${order.id}`}
                        ...
                        {filteredOrders.length > 0 && (
                            <tfoot className="bg-[#F8FAFC] border-t-2 border-[rgba(15,23,42,0.07)] print:bg-transparent print:border-t-2 print:border-gray-800">
                                <tr>
                                    <td
                                        colSpan={4}
                                        className="px-5 py-4 text-right font-bold text-[#0F172A] uppercase tracking-wider text-xs"
                                    >
                                        Total Ingresos
                                    </td>
