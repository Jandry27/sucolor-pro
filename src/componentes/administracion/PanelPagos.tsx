        ...
        <div className="glass-card space-y-4" style={{ padding: '20px' }}>
            ...
            {!editing && (
                <div className="grid grid-cols-2 gap-3">
                    {[
                        ...
                        <div
                            key={label}
                            className="rounded-xl p-3 text-center border border-[rgba(15,23,42,0.07)]"
                            style={{ background: 'rgba(255, 255, 255, 0.5)' }}
                        >
                            <p className="text-xs text-[rgba(15,23,42,0.45)] mb-1">{label}</p>
                            <p
                                className={`font-bold text-sm ${highlight ? 'text-[#16A34A]' : 'text-[#0F172A]'}`}
                            >
                                {value}
                            </p>
                        </div>
            ...
            {!editing && (
                <div className="mt-6 pt-5 border-t border-[rgba(15,23,42,0.06)] space-y-3">
                    <div className="flex items-center justify-between">
                        <h4 className="text-xs font-bold text-[rgba(15,23,42,0.50)] uppercase tracking-wider">
                            Historial de Abonos
                        </h4>
                        {!addingAbono && !completo && (
                            <button
                                onClick={() => setAddingAbono(true)}
                    ...
                    {addingAbono && (
                        <div className="p-3 rounded-xl bg-[#F7F8FA] border border-[rgba(15,23,42,0.07)] space-y-3">
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <label className="text-[10px] uppercase font-bold text-[rgba(15,23,42,0.40)] mb-1 block">
                                        Fecha
                                    </label>
                                    <input
                                        type="date"
                                        ...
                                        onChange={e =>
                                            setNewAbono({ ...newAbono, fecha: e.target.value })
                                        }
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            setNewAbono({ ...newAbono, monto: e.target.value })
                                        }
                                        placeholder="0.00"
                                        className="input-field text-xs py-1.5"
                                    />
                                ...
                                <div className="col-span-2">
                                    ...
                                    <input
                                        ...
                                        value={newAbono.nota}
                                        onChange={e =>
                                            setNewAbono({ ...newAbono, nota: e.target.value })
                                        }
                            ...
                            <div className="flex gap-2 pt-1">
                                ...
                                <button
                                    onClick={saveAbono}
                                    disabled={saving || !newAbono.monto}
                    ...
                    {abonos.length === 0 ? (
                        <div className="flex flex-col items-center py-4 bg-[rgba(15,23,42,0.02)] rounded-lg border border-[rgba(15,23,42,0.05)] border-dashed">
                            <p className="text-xs text-[rgba(15,23,42,0.40)]">
                        ...
                        <div className="space-y-2">
                            {abonos.map((a, i) => (
                                <div
                                    key={a.id || i}
                                    className="flex items-center justify-between p-2.5 rounded-lg bg-white border border-[rgba(15,23,42,0.05)] shadow-sm"
                                >
                                    <div>
                                    ...
                                    <button
                                        onClick={() => deleteAbono(a.id)}
                                        disabled={saving}
                                        className="text-[rgba(15,23,42,0.25)] hover:text-red-500 p-1"
                                    >
