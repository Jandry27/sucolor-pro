            ...
            {COLUMNS.map(col => {
                ...
                return (
                    <div key={col.estado} className="flex-shrink-0 w-[260px] flex flex-col gap-2.5"
                        ...
                        {/* Column header */}
                        <div className="flex items-center justify-between px-3 py-2 bg-white rounded-xl border border-[rgba(15,23,42,0.07)]"
                            style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 rounded-full flex-shrink-0"
                                    style={{ backgroundColor: col.color }} />
                                <span className="text-xs font-semibold text-[#0B1220]">{col.label}</span>
                            </div>
