        ...
        <motion.div className="glass-card" style={{ padding: '20px' }}
            ...
            <div className="flex items-center gap-2.5 mb-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center"
                    ...
                    <StickyNote className="w-4 h-4 text-[#FF6A00]" />
                </div>
                ...
                {lines.map((line, i) => {
                    ...
                    return (
                        <div key={i} className="flex items-start gap-3 relative pb-2 last:pb-0">
                            ...
                            <div className="w-2 h-2 rounded-full bg-[#FF6A00] mt-[6px] flex-shrink-0 shadow-[0_0_0_4px_rgba(255,106,0,0.15)] z-10" />
                            <p className="text-sm text-[rgba(15,23,42,0.75)] dark:text-slate-300 leading-relaxed font-medium">
                                {isDated ? (
                                    <>
                                        <span className="font-bold text-[#FF6A00] mr-1">
                                            {line.match(/^• (\[[^\]]+\])/)?.[1]}
                                        </span>
                                        {line.replace(/^• \[[^\]]+\]\s*/, '')}
                                    </>
